            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6 mt-2">
                        ...
                        <select name="idPersona" id="idPersona" class="form-control" style="border-radius: 5px;">
                       </select>
                    </div>
                    <div class="col-md-6 mt-2">
                        ...
                        <input id="codigoActivo" list="activo" class="form-control" style="border-radius: 5px;">
                    </div>
                    <div class="col-md-6 mt-2">
