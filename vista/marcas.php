            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-4 col-xl-4 input-group mt-2">
                      ...
                      <input class="form-control" id="idMarca"  type="search" placeholder="Buscar por Nombre" aria-label="Buscar" autofocus>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mt-2 mt-2">
                        <label for="nombres">Nombre</label>
                        <input type="text" name="nombre" id="nombre" placeholder="Ingrese el nombre de la marca" class="form-control text-mayus">
                    </div>
                </div>
            </div>
            <div class="card-footer">
                <table class="table tabled-bordered table-sm" id="tablaMarca">
                    <thead>
                        <tr>
                            <th>Nombre</th>
